...
namespace LogExpert
{
	partial class LogWindow
	{
	  ...
	  this.dataGridView.Enter += new System.EventHandler(this.DataGridView_InvalidateCurrentRow);
      ...
      this.dataGridView.Leave += new System.EventHandler(this.DataGridView_InvalidateCurrentRow);
	  ...
	  this.copyToTabToolStripMenuItem.Click += new System.EventHandler(this.Copy_Click);
      // 
      // toolStripSeparator1
      // 
	  ...
	  this.filterRangeComboBox.TextChanged += new System.EventHandler(this.FilterChanges_CheckForDirty);
      // 
      // columnNamesLabel
      // 
	  ...
	  this.fuzzyKnobControl.ValueChanged += new LogExpert.KnobControl.ValueChangedEventHandler(this.FilterChanges_CheckForDirty);
      // 
	  ...
	  this.invertFilterCheckBox.CheckedChanged += new System.EventHandler(this.FilterChanges_CheckForDirty);
      // 
      // panel4
      // 
	  ...
	  this.filterGridView.Enter += new System.EventHandler(this.FilterGridView_InvalidateCurrentRow);
	  ...
	  this.filterGridView.Leave += new System.EventHandler(this.FilterGridView_InvalidateCurrentRow);
      ...
      this.filterCaseSensitiveCheckBox.CheckedChanged += new System.EventHandler(this.FilterChanges_CheckForDirty);
      // 
      // filterSearchButton
      // 
	  ...
	  this.filterComboBox.TextChanged += new System.EventHandler(this.FilterChanges_CheckForDirty);
      // 
	  ...
	  this.highlightSelectionInLogFilewordModeToolStripMenuItem.Click += new System.EventHandler(this.HighlightSelectionInLogFileToolStripMenuItem_Click);
      // 

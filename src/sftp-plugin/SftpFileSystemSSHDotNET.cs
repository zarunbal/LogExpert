...
{
    public class SftpFileSystemSSHDotNET : IFileSystemPlugin, ILogExpertPluginConfigurator
    {
        #region Fields
        ...
        public SftpFileSystemSSHDotNET(IFileSystemCallback callback)
        {
        ...
        public ILogFileInfo GetLogfileInfo(string uriString)
        {
            try
            {
                ...
                return new SftpLogFileInfoSSHDotNET(this, uri, _logger);
            }
            catch (Exception e)
            {
                _logger.LogError(e.Message);

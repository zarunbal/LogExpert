...
namespace LogExpert
{
    public class Eminus : IContextMenuEntry, ILogExpertPluginConfigurator
    {
        ...
        #region Interface IContextMenuEntry
        ...
        public void LoadConfig(string configDir)
        {
            ...
            else
            {
                ...
                try
                {
                    config = (EminusConfig)formatter.Deserialize(fs);
                }
        ...
        private XmlDocument BuildXmlDocument(string className, string lineNum)
        {
            ...
            rootElement.SetAttribute("authKey", config.password);

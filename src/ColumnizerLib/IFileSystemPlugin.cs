namespace LogExpert
{
    ...
    /// </summary>
    /// <remarks>
    ///     LogExperts file handling is done via file system plugins. The selection if the appropriate plugin for a file is
    ///     based
    ///     on URI schemes. If a file system plugin returns <code>true</code> to the <see cref="CanHandleUri" /> method, it
    ///     will be selected
    ///     to handle a file.
    /// </remarks>
    public interface IFileSystemPlugin
    {
        ...
        ///     The method is called from LogExpert when a file is about to be opened. It's called after
        ///     <see cref="CanHandleUri" /> was called.
        /// </summary>

namespace LogExpert
{
    ...
    ///         All this stuff must be provided by returning a IXmlLogConfiguration in the
    ///         <see cref="GetXmlLogConfiguration" /> method.
    ///     </para>
    ///     <para>
    ///         The processing of XML log files is done in the following steps:
    ///         <ol>
    ///             <li>
    ///                 LogExpert reads the file and separates it into fragments of XML content using the given
    ///                 start/end tags (<see cref="GetXmlLogConfiguration" />)
    ///             </li>
    ///             <li>
    ///                 The fragments will be translated using the given XSLT (<see cref="GetXmlLogConfiguration" />)
    ...
    ///             </li>
    ///             <li>
    ///                 The lines will be passed to the usual <see cref="ILogLineColumnizer" /> methods before displaying. So
    ///                 you can handle
    ...
    public interface ILogLineXmlColumnizer : ILogLineColumnizer
    {
        ...
        /// </summary>
        /// <param name="logLine">
        ///     The line as retrieved from the internal log reader. This is

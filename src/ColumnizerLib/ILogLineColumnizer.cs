...
namespace LogExpert
{
    ...
    public interface ILogLineColumnizer
    {
        ...
        /// <summary>
        ///     Returns the names of the columns. The returned names are used by LogExpert for the column headers in the data grid
        ///     view.
        ...
        /// </summary>
        /// <remarks>
        ///     When implementing this function you have to parse the given log line for a valid date/time to get a DateTime
        ///     object.
        ///     Before returning the DateTime object you have to add the offset which was set by SetTimeOffset().<br></br>
        ///     <br></br>
        ///     Note: If not all lines of your log files contain a valid date/time it's recommended to do some fail-fast pre checks
        ///     before
        ///     calling the parse functions of DateTime. This saves a lot of time because DateTime.ParseExact() is very slow when
        ///     fed with
        ///     invalid input.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        ///     You should parse both values (oldValue, value) for valid timestamps, determine the time offset and store the offset
        ///     as
        ...
        /// </summary>
        /// <remarks>
        ///     You have to store the given value in the Columnizer instance and add this offset to the timestamp column(s)
        ///     returned by SplitLine()
        ...
        ///     If your columnizer implementation supports timeshift (see
        ///     <see cref="IsTimeshiftImplemented">IsTimeshiftImplemented</see>)
        ///     you have to add the timestamp offset to the columns representing the timestamp (e.g. columns like 'date' and
        ///     'time').
        ///     In practice this means you have to parse the date/time value of your log line (see
        ///     <see cref="GetTimestamp">GetTimestamp</see>)

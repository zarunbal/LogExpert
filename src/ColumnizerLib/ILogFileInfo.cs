...
{
    /// <summary>
    ///     Interface which represents a file in LogExpert. 'File' could be anything that represents text data to be displayed
    ///     in LogExpert.
    /// </summary>
    public interface ILogFileInfo
    {
        ...
        /// <summary>
        ///     The interval (in ms) LogExpert should check for file changes. The property is checked by LogExpert repeatedly in
        ///     the loop which
        ///     checks for file changes. So you can adjust the poll interval as needed. E.g. you can lower the interval when many
        ///     changes occur and

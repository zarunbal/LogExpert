...
///     (non-XML) log files.
/// </li>
/// <li>The lines will be passed to the usual <see cref="ILogLineMemoryXmlColumnizer"/> methods before displaying. So you can handle
///     field splitting in the way known from <see cref="ILogLineMemoryXmlColumnizer"/>.
/// </li>
/// </ol>
/// </para>
/// </remarks>
public interface ILogLineMemoryXmlColumnizer : ILogLineMemoryColumnizer
{
    ...
    /// </remarks>
    ILogLineMemory GetLineTextForClipboard (ILogLineMemory logLine, ILogLineMemoryColumnizerCallback callback);

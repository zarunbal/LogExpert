...
namespace LogExpert.Dialogs
{
    public partial class BookmarkWindow : DockContent, ISharedToolWindow, IBookmarkView
    {
        ...
        public void SetBookmarkData(IBookmarkData bookmarkData)
        {
            ...
            bookmarkDataGridView.RowCount = this.bookmarkData != null ? this.bookmarkData.Bookmarks.Count : 0;
            HideIfNeeded();
        }

        public void UpdateView()
        {
            bookmarkDataGridView.RowCount = bookmarkData != null ? bookmarkData.Bookmarks.Count : 0;
            ResizeColumns();
            bookmarkDataGridView.Refresh();
        }
        ...
        #region Interface ISharedToolWindow

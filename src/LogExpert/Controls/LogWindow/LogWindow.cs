...
namespace LogExpert
{
    public partial class LogWindow : DockContent, ILogPaintContext, ILogView
    {
        ...
        private int filterPipeNameCounter;
        ...
        private int reloadOverloadCounter;
        private SortedList<int, RowHeightEntry> rowHeightList = new SortedList<int, RowHeightEntry>();
        private int selectedCol; // set by context menu event for column headers only
...
// Thread.CurrentThread.Name = "LogWindowThread";
            ...
            filterGridView.CellValueNeeded +=
                filterGridView_CellValueNeeded;
            ...
            timeSpreadingControl1.LineSelected +=
                timeSpreadingControl1_LineSelected;
...
// PreferencesChanged(settings.preferences, true);
            ...
            bookmarkProvider.BookmarkAdded +=
                bookmarkProvider_BookmarkAdded;
            bookmarkProvider.BookmarkRemoved +=
                bookmarkProvider_BookmarkRemoved;
            bookmarkProvider.AllBookmarksRemoved +=
                bookmarkProvider_AllBookmarksRemoved;

            ResumeLayout();

            statusLineTrigger.Signal += statusLineTrigger_Signal;
            selectionChangedTrigger.Signal +=
                selectionChangedTrigger_Signal;
        ...
        #region Nested type: ColumnizerCallback
        ...
        public class ColumnizerCallback : ILogLineColumnizerCallback
        {
            ...
            #region Interface ILogLineColumnizerCallback
        ...
        #region Nested type: LogExpertCallback
        ...
        public class LogExpertCallback : ColumnizerCallback, ILogExpertCallback
        {
            ...
            #region Interface ILogExpertCallback

...
// ConnectToolWindows(newLogWindow);
        ...
        {
            for (int syncMode = 0; syncMode <= 1; syncMode++)
            {
// LED indicating time synced tabs
...
// process.BeginOutputReadLine();
        ...
        private void StatusLineEventWorker(StatusLineEventArgs e)
        {
            ...
            linesLabel.Text = string.Empty + e.LineCount + " lines";
            sizeLabel.Text = Util.GetFileSizeAsText(e.FileSize);
            currentLineLabel.Text = string.Empty + e.CurrentLineNum;
